...
# 爱奇艺cookie
P00001 = "f1m2DbTm2Ypdm1SfaXyiDus5rQxC5s8X8PnjrTDVddv9gnY2wMhdx9qs3d9Jm2VRurUm3jtc5"
P00003 = "1189773740"
dfp = "a0e68518b8d20b43ca98beef06d2d8ec9f153d9b6e36e9e9027ee6126d7551665f"  # 只要‘字符串‘，删除’@数字@数字’
...
agentid = 1000000  # 填写你的应用ID，不加引号，是个整型常数,就是AgentId
touser = "@all"  # 指定接收消息的成员，成员ID列表（多个接收者用‘|’分隔，最多支持1000个）。特殊情况：指定为”@all”，则向该企业应用的全部成员发送
